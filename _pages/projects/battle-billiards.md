...
project_nav_title: "Battle Billiards"
permalink: /projects/battle-billiards/
nav: false
---
...
<img class="mx-lg-auto img-fluid mt-1 mb-4" height="40%" src="{{ '/assets/img/projects/battle-billiards/bbdecor-01.png' | relative_url }}" width="40%"/>
<h1 class="display-5 fs-1 fw-bold lh-1 mb-5">Battle Billiards</h1>
...
<p class="lead text-muted fs-6 lh-sm mb-1">
<small class="fw-bold">Date:</small> Dec. 2021 - Apr. 2022
                </p>
<p class="lead text-muted fs-6 lh-sm mb-1">
...
<a class="btn btn-sm btn-outline-dark" href="https://www.youtube.com/watch?v=yTX2zmeNWkg">Video</a>
</div>
</div>
</div>
</section>
...
<div class="row flex-lg-row-reverse align-items-center py-5 mb-3 bg-image-container" style="background-image: url('{{ '/assets/img/projects/battle-billiards/bb01-bg.png' | relative_url }}')">
<div class="col-lg-5">
...
<img src="{{ '/assets/img/projects/battle-billiards/bb03.png' | relative_url }}" style="height: 100%;"/>
</div>
<div class="row flex-lg-row align-items-center py-4 mb-3">
<img src="{{ '/assets/img/projects/battle-billiards/bb04.png' | relative_url }}" style="height: 100%;"/>
<p class="taxt-dark mt-2 fw-light fs-6 text-center">
                        Oasis-themed standard Billiards' Table Scene in Unity3D HDRP
                    </p>
</div>
<div class="row flex-lg-row align-items-center py-4 mb-3">
<img src="{{ '/assets/img/projects/battle-billiards/bb05.jpg' | relative_url }}" style="height: 100%;"/>
</div>
<div class="row flex-lg-row align-items-center py-4 mb-3">
<img src="{{ '/assets/img/projects/battle-billiards/bb06.jpg' | relative_url }}" style="height: 100%;"/>
<p class="taxt-dark mt-2 fw-light fs-6 text-center">
                        Oasis-themed standard Billiards' Table Scene in Substance Painter
                    </p>
</div>
<div class="row flex-lg-row align-items-center py-4 mb-3">
<img src="{{ '/assets/img/projects/battle-billiards/bb07.png' | relative_url }}" style="height: 100%;"/>
</div>
<div class="row flex-lg-row align-items-center py-4 mb-3">
<img src="{{ '/assets/img/projects/battle-billiards/bb08.png' | relative_url }}" style="height: 100%;"/>
<p class="taxt-dark mt-2 fw-light fs-6 text-center">
                        Oasis-themed hexagonal Billiards' Table Scene in Unity3D HDRP
                    </p>
</div>
<div class="row flex-lg-row align-items-center py-4 mb-3">
<img src="{{ '/assets/img/projects/battle-billiards/bb09.jpg' | relative_url }}" style="height: 100%;"/>
</div>
<div class="row flex-lg-row align-items-center py-4 mb-3">
<img src="{{ '/assets/img/projects/battle-billiards/bb10.jpg' | relative_url }}" style="height: 100%;"/>
<p class="taxt-dark mt-2 fw-light fs-6 text-center">
                        Ice-themed standard Billiards' Table Scene in Substance Painter
                    </p>
</div>
<div class="row flex-lg-row align-items-center py-4 mb-3">
<img src="{{ '/assets/img/projects/battle-billiards/bb11.png' | relative_url }}" style="height: 100%;"/>
</div>
<div class="row flex-lg-row align-items-center py-4 mb-3">
<img src="{{ '/assets/img/projects/battle-billiards/bb12.png' | relative_url }}" style="height: 100%;"/>
<p class="taxt-dark mt-2 fw-light fs-6 text-center">
                        Ice-themed standard Billiards' Table Scene in Unity3D HDRP
                    </p>
</div>
</div>
</div>
