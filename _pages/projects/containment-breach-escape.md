...
project_nav_title: "Containment Breach Escape"
permalink: /projects/containment-breach-escape/
nav: false
---
...
<img class="mx-lg-auto img-fluid mt-1 mb-4" height="60%" src="{{ '/assets/img/projects/containment-breach-escape/escapedecor01.png' | relative_url }}" width="60%"/>
<h1 class="display-5 fs-1 fw-bold lh-1 mb-5">Containment Breach Escape</h1>
...
<p class="lead text-muted fs-6 lh-sm mb-1">
<small class="fw-bold">Date:</small> Sept. 2019 - Dec. 2019
                </p>
<p class="lead text-muted fs-6 lh-sm mb-1">
...
<img class="bd-placeholder-img mt-5" height="100%" src="{{ '/assets/img/projects/containment-breach-escape/escape03.png' | relative_url }}" width="100%"/>
</div>
</div>
<div class="row flex-lg-row align-items-center py-4 mb-3">
<img src="{{ '/assets/img/projects/containment-breach-escape/escape04.jpg' | relative_url }}" style="height: 100%;"/>
<p>
                         
                    </p>
...
<div class="col-lg-7 px-0 text-center">
<img class="bd-placeholder-img mt-5" height="100%" src="{{ '/assets/img/projects/containment-breach-escape/escape06.png' | relative_url }}" width="100%"/>
</div>
</div>
<div class="row flex-lg-row align-items-center py-4 mb-3">
...
<img class="bd-placeholder-img mt-5" height="100%" src="{{ '/assets/img/projects/containment-breach-escape/escape08.png' | relative_url }}" width="100%"/>
</div>
</div>
<div class="row flex-lg-row align-items-center py-4 mb-3">
...
<iframe allowfullscreen="" class="bd-placeholder-img card-img-top project-youtube-frame" frameborder="0" height="700" src="https://www.youtube.com/embed/ZxUvBfGuBsI?si=nsDEQuLGqasKap-A"></iframe>
<div class="card-body">
</div>
</div>
</div>
