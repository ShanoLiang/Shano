...
project_nav_title: "COVID Control Simulator"
permalink: /projects/covid-control-simulator/
nav: false
---
...
<img class="mx-lg-auto img-fluid mt-1 mb-4" height="40%" src="{{ '/assets/img/projects/covid-control-simulator/covidsimdecor02.png' | relative_url }}" width="40%"/>
<h1 class="display-5 fs-1 fw-bold lh-1 mb-5">COVID Control Simulator</h1>
...
<a class="btn btn-sm btn-outline-dark" href="https://www.wpi.edu/news/chance-run-city-besieged-virus">News</a>
<a class="btn btn-sm btn-outline-dark" href="{{ '/assets/pdf/projects/Game System in the COVID-19 Control Sim.pdf' | relative_url }}">PDF: The System of the Project</a>
</div>
</div>
</div>
</section>
...
<div class="image-container">
<img src="{{ '/assets/img/projects/covid-control-simulator/bb02-3.png' | relative_url }}" style="height: 100%;"/>
...
<div class="image-container">
<img class="bd-placeholder-img mt-5" height="100%" src="{{ '/assets/img/projects/covid-control-simulator/covidsim02.png' | relative_url }}" width="100%"/>
<div class="overlay-text-b">
<p class="color-text-cyan-light fs-5 fw-bolder lh-sm px-0">
                                    The simulator with real-world-based data and map.
                                </p>
</div>
</div>
</div>
...
<img src="{{ '/assets/img/projects/covid-control-simulator/covidsim03.png' | relative_url }}" style="height: 100%;"/>
